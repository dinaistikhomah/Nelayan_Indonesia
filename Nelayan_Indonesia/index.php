...
<head>
    ...
    <title>Aplikasi Dina Istikhomah</title>
  ...
  <body>
	...
	if( isset( $_REQUEST['login'] ) ){
		...
		$sql = mysqli_query($koneksi, "SELECT id_user, username, password, nama, level FROM user WHERE username='$username' AND password='$password'");

        //jika skript query benar maka akan membuat session
		if( $sql){
			list($id_user, $username, $password, $nama, $level) = mysqli_fetch_array($sql);
